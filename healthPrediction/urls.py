...
urlpatterns = [
    ...
    path('manage_medicines/', views.manage_medicines, name='manage_medicines'),
    path('manage_medicines/add/', views.add_medicine, name='add_medicine'),
    path('manage_medicines/<int:medicine_id>/edit/', views.edit_medicine, name='edit_medicine'),
    path('manage_medicines/<int:medicine_id>/delete/', views.delete_medicine, name='delete_medicine'),
    path('logout/', views.logout_view, name='logout'),
